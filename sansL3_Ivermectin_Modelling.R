...
# DO NOT REMOVE THE LARVAL COMPARTMENTS UNDER ANY CIRCUMSTANCES AS IF WE JUST ASSUME PEOPLE'RE AT EQUILIBRIUM 
# THEN WE"RE GOING TO MESS UP THEIR CHI IN A MAJOR WAY THAT WE SHOULD NOT IGNORE. BUT THAT ASSUMES THAT L3 LARVAE
#  DEVELOPING INTO ADULT WORMS DON'T GET ANY WORK EXPERIENCE OR ANY EFFECTS FROM TREATMENT. 
#  WHICH IS MAYBE FINE IF WE'RE ASSUMING THAT THE DRUG ONLY AFFECTS FERTILITY, NOT EMPLOYMENT RATE. 
